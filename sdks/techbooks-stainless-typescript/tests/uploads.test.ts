import fs from 'fs';
import type { ResponseLike } from 'techbooks-stainless/internal/to-file';
import { toFile } from 'techbooks-stainless/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('techbooks-stainless/core/uploads');
    await expect(
