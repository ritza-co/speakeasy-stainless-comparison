...
import { ClientOptions } from 'techbooks-stainless';
...
export { ClientOptions } from 'techbooks-stainless';
export { endpoints } from './tools';

export const newMcpServer = () =>
  new McpServer(
    {
      name: 'techbooks_stainless_api',
      version: '0.0.1',
    },
...
export function initMcpServer(params: {
  ...
  let client = new TechbooksStainless({
    logger,
