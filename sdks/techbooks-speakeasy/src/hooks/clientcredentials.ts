  ...
  implements SDKInitHook, BeforeRequestHook, AfterErrorHook
{
  ...
  private async getCredentialsGetAllBooks(
    ...
    const out = parse(
      security,
      (val) => operations.GetAllBooksSecurity$outboundSchema.parse(val),
  ...
  private async getCredentialsGetAllOrders(
    ...
    const out = parse(
      security,
      (val) => operations.GetAllOrdersSecurity$outboundSchema.parse(val),
      "unexpected security type",
    );
  ...
  private async getCredentialsCreateOrder(
    ...
    const out = parse(
      security,
      (val) => operations.CreateOrderSecurity$outboundSchema.parse(val),
      "unexpected security type",
    );
  ...
  private async getCredentialsGetOrderById(
    ...
    const out = parse(
      security,
      (val) => operations.GetOrderByIdSecurity$outboundSchema.parse(val),
      "unexpected security type",
    );
