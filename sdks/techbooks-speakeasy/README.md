...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/ritza-rzx/ritza-gareth). Delete this section before > publishing to a package manager.
...
- [`booksAddBook`](docs/sdks/books/README.md#addbook) - Add a new book
- [`booksGetAllBooks`](docs/sdks/books/README.md#getallbooks) - Get all books
- [`booksGetBookById`](docs/sdks/books/README.md#getbookbyid) - Get a book by ID
- [`booksUpdateBookCoverById`](docs/sdks/books/README.md#updatebookcoverbyid) - Update a book cover by ID
- [`ordersCreateOrder`](docs/sdks/orders/README.md#createorder) - Create a new order
- [`ordersGetAllOrders`](docs/sdks/orders/README.md#getallorders) - Get all orders
- [`ordersGetOrderById`](docs/sdks/orders/README.md#getorderbyid) - Get an order by ID
- [`ordersGetOrderStream`](docs/sdks/orders/README.md#getorderstream) - Get a stream of orders
